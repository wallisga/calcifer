...
Bare metal running Proxmox VE 8. Hosts various VMs and has domain-joined access to shared resources on the network.
...
- **Created:** 2025-11-23
- **Purpose:** Monitor availability of proxmox
